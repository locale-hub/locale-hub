...
export default function Select({
  ...
  const [selected, setSelected] = useState<SelectEntry>(defaultSelected);
        ...
        {({ open }) => (
          <>
            ...
            <div className="relative mt-1 text-black">
              <Listbox.Button
                className="relative w-full hover:cursor-pointer rounded-md border border-gray-300 bg-white
