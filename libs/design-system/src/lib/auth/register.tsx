...
export default function RegisterPage({
  ...
  const formInvalid = () => 'error' in schema.validate({ name, email, password, passwordConfirm });
  ...
  return <div className="mt-8 space-y-6">
    <div className="grid">
      ...
      <InputField name={'password-confirm'} label={'Confirm Password'} onValue={setPasswordConfirm} type={'password'} value={passwordConfirm} placeholder='Confirm Password' />
    </div>

    <div className='flex justify-end mt-8'>
      <Button className="relative flex w-32 justify-end"
              type='action' onClick={doRegister} disabled={formInvalid()}
      >
