    ...
    <>
      <div className="p-10 mt-16 w-3/4 m-auto">
        <div className="mb-12 p-8 rounded-md border border-slate-400/50">
          ...
          <p className="text-sm">
            Bundle containing all the translation files with the latest values
          </p>
          <div className="mt-6">
            <Button type="confirm" onClick={() => download(FileFormat.ANDROID)}>
              Android
            </Button>
            <Button type="confirm" onClick={() => download(FileFormat.IOS)}>
              iOS
            </Button>
          </div>
        </div>
