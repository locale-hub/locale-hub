...
export default function AddUserModal({
  ...
  return <Dialog as="div" className="relative" open={isOpen} onClose={() => onClose(userId)}>
      ...
      <div className="flex min-h-full items-center justify-center p-4 text-center">
          <Dialog.Panel className="w-2xl h-2xl transform rounded-2xl bg-white dark:bg-slate-800 p-6 text-left align-middle shadow-xl transition-all">
            ...
            <div className="mt-2 text-black">
              <div className='w-96'>
                <Select
                  ...
                  label='User'
                  defaultSelected={{ id: users[0].id, value: `${users[0].name} <${users[0].primaryEmail}>` }}
            ...
            <div className="mt-8 text-black text-right">
              ...
              <Button type='confirm' onClick={() => onClose(userId)}>Add</Button>
            </div>
          </Dialog.Panel>
      </div>
    </div>
