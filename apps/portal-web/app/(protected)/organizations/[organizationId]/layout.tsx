...
export default function OrganizationLayout({
  ...
  return <div className='flex height-full'>
    <div className='w-2/12 min-h-full'>
      <Sidebar data={[
        { name: 'Projects', link: routes.organizations.projects(organizationId), icon: <HomeIcon className='w-6 h-6' /> },
        { name: 'Users', link: routes.organizations.users(organizationId), icon: <UsersIcon className='w-6 h-6' /> },
        { name: 'Usage', link: routes.organizations.usage(organizationId), icon: <ChartPieIcon className='w-6 h-6' /> },
