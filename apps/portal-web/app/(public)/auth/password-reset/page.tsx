...
export default function PasswordResetPage() {
  ...
  return (
    <div className="flex min-h-full items-center justify-center px-10 py-10 sm:px-6 lg:px-8">
      <div className="w-full max-w-4xl space-y-8 text-center">
        <h2 className="mt-6 text-3xl font-bold">Password reset request</h2>

        <p>
          Please give us your email address so we can send you a link to reset
          your password.
          <br />
          This is required to ensure nobody else than you is actually resetting
          your password.
        </p>
          ...
          <div className="w-full mt-8 flex justify-end">
            <div className="text-sm font-medium my-auto">
              <Link href={routes.auth.root} className="text-warn">
                <ChevronLeftIcon
                  className="h-5 w-5 inline-block mr-1 align-top"
                  aria-hidden="true"
                />
                Go back to login
              </Link>
