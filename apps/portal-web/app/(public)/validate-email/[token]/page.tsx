...
export default function ProjectCommitsPage({
  ...
  return <div className='px-10 py-48 m-auto w-full text-center'>
    ...
    { 'failure' === status && <p>Failure - We could not validate your email.<br />The link might be expired, please try again</p> }
    { 'success' === status && <p>Success - Email has been added to you account!</p> }
  </div>;
}
