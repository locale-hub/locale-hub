          ...
          <Dialog.Panel className="w-2xl h-2xl transform rounded-2xl bg-white dark:bg-slate-800 p-6 text-left align-middle shadow-xl transition-all">
            ...
            <div className="mt-2">
              <div className="w-96">
                ...
                <br />
                This will permanently revoke access to the user John Doe to this
                project.
                <br />
            ...
            <div className="mt-8 text-black text-right">
              <Button type="cancel" onClick={() => onClose(false)}>
                Cancel
              </Button>
              <Button type="confirm" onClick={() => onClose(true)}>
                Revoke access to {user.name}
              </Button>
            </div>
          </Dialog.Panel>
        </div>
